...
## Project Structure
    ...
    ├── perfection_moving_35032  # Django project configurations
...
1. Clone this repo and `cd perfection_moving_35032`
...
2. Clone this repo and `cd perfection_moving_35032`
